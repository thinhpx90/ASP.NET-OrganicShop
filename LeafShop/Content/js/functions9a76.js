	...
	SEMICOLON.header = {
		...
		menufunctions: function(){
			...
			if( SEMICOLON.isMobile.Windows() ) {
				...
				$( '#primary-menu ul li:has(ul)' ).append('<a href="#" class="wn-submenu-trigger"><i class="fa-angle-down"></i></a>');
		...
		navTree: function(){
			...
			if( $navTreeEl.length > 0 ){
				$navTreeEl.each( function(){
					...
					element.find( 'ul li:has(ul) > a' ).append( ' <i class="fa-angle-down"></i>' );
	...
	var lazyLoad = function() {
		...
		if( lazyLoadEl.length > 0 ) {
			lazyLoadEl.each( function(){
				...
				element.attr( 'src', '//theme.hstatic.net/1000104489/1000257823/14/blank.svg?v=3658' ).css({ 'background': 'url(//theme.hstatic.net/1000104489/1000257823/14/preloader.gif?v=3658) no-repeat center center #FFF' });
